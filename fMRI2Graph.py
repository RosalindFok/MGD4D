...
def clear_temporary_files_of_ants(temp_dir_path : Path = Path("C:") / "Users" / "26036" / "AppData"/ "Local" / "Temp") -> None:
    # TODO: set your own temp_dir_path.
...
def preprocess_anat3d_and_func4d_with_atlas(saved_dir_path : Path, 
                                            ...
                                            atlas_path : Path = Paths.BN_Atlas_246_1mm_nii_path
                                        ) -> None:
...
def process_ds002748(dir_path : Path = Paths.ds002748_dir_path) -> None:
    """
    fMRI
    ...
    for sub_name in sub_anat_nii_path_dict.keys():
        ...
        preprocess_anat3d_and_func4d_with_atlas(saved_dir_path=saved_dir_path, 
                                                ...
                                                atlas_path=Paths.BN_Atlas_246_1mm_nii_path)        
        

def process_ds003007(dir_path : Path = Paths.ds003007_dir_path) -> None:
    """
    fMRI
    ...
    depr_nfb: patients who undergo rt-fmri neurofeedback treatment course
    ...
    for d in sub_dir_path_list:
        # pre
        saved_pre_dir_path = Paths.run_files_ds003007_dir_path / "pre" / d.name
        ...
        # post
        saved_post_dir_path = Paths.run_files_ds003007_dir_path / "post" / d.name
