...
def train_val_pipeline(MODEL_NAME, DATASET_NAME, params, net_params, dirs):
    ...
    dataset = LoadData(DATASET_NAME, threshold=params['threshold'], node_feat_transform=params['node_feat_transform'])
    ...
    try:
        for split_number in range(10):
            ...
            if net_params['contrast'] and MODEL_NAME in ['ContrastPool']:
                model.cal_contrast(trainset, device)
